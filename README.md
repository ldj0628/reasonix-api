...
实验室提供了 AI Token 账号，供科研使用。请根据个人研究方向和需求选择合适的模型，并完成申请流程。实验室目前提供如下模型：

   - **DeepSeek**：每月 20 人民币额度
...
- **命名保持一致**：Reasonix 中的「自定义供应商名称」与站点「API 密钥名称」保持同名（如 `ai.matrix-lab`），便于日志对账与后续排查。
